...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const scrollElements = document.querySelectorAll(".scroll-revealed");
                ...
                <div className="row">
                  <div className="col-12 md:col-6 xl:col-12">
                    <div className="scroll-revealed py-5 px-6 rounded-xl shadow-card-1 bg-body-light-1 dark:bg-primary-dark-2 flex gap-6 hover:shadow-lg">
                      <div>
                        <i className="lni lni-laptop-phone w-[50px] h-[50px] inline-flex items-center justify-center rounded-lg text-[1.25rem] bg-primary text-primary-color" />
                      </div>
                      <div>
